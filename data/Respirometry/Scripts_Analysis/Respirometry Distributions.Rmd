...
dataBEUZ=subset(dataBEUZ,treat!="3")
dataBEUZ=subset(dataBEUZ,treat!="4")
wetmasspeakBEUZ=aggregate(max ~ day*strain+treat+syringe, data = dataBEUZ, FUN = max)
View(wetmasspeakBEUZ)
datamassmax=lm(mass~day,wetmasspeakBEUZ)
summary(datamassmax)
